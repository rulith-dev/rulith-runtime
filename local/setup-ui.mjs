...
$('model-save').onclick=()=>act(async()=>{await api('/setup/model',{url:$('model-url').value,name:$('model-name').value,key:$('model-key').value});$('model-key').value='';await refresh();$('notice').textContent='Model settings saved locally.';});
